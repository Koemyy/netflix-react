                        ...
                        <div className="max-w-[320px] mx-auto py-16">
                            ...
                            <form onSubmit={handleSubmit} className="w-full flex flex-col py-4">
                                <input onChange={(e) => setEmail(e.target.value)}
                                       className="p-3 my-2 bg-gray-700 rounded" placeholder="Email" type="email"
                                       autoComplete="email"/>
                                <input onChange={(e) => setPassword(e.target.value)}
                                       className="p-3 my-2 bg-gray-700 rounded" placeholder="Password" type="password"
                                ...
                                <p className="py-8 space-x-2"><span className="text-gray-600">New to Netflix?</span>
